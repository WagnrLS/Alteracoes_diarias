...
def adicionar_tarefa():
    ...
    if codigo_vendedor and codigo_cliente and razao_social and alteracao and prazo:
...
def salvar_edicao():
    ...
    if tarefa_em_edicao:
        ...
        tarefa_selecionada = tarefas_a_fazer.item(tarefa_em_edicao, "values")
        novo_prazo = tarefa_selecionada[4]
        tarefas_a_fazer.item(tarefa_em_edicao, values=(*tarefa_selecionada[:3], nova_alteracao, novo_prazo))
        alteracao_entry.delete(0, tk.END)
        tarefa_em_edicao = None
